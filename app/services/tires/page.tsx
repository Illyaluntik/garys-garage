...
const serviceData = {
  ...
  heroImage: withBasePath("/images/service-tires.jpg"),
  capabilities: [
  ...
  images: [
    { src: withBasePath("/images/service-tires.jpg"), alt: "Commercial truck tires" },
    { src: withBasePath("/images/service-repair.jpg"), alt: "Tire service" },
    { src: withBasePath("/images/service-roadside.jpg"), alt: "Emergency tire repair" },
  ],
}
